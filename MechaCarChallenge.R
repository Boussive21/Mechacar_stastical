...
library(tidyverse)
mecha_mpg <- read.csv(file='R scripting/Resources/MechaCar_mpg.csv',check.names=F,stringsAsFactors = F) 
...
mecha_coil <- read.csv(file='R scripting/Resources/Suspension_Coil.csv',check.names=F,stringsAsFactors = F) 
